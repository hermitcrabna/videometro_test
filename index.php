...
<head>
  ...
  <style>
    ...
    .type-icon { width:46px; height:46px; border-radius:999px; background: rgba(15,17,21,.7); border:1px solid rgba(255,255,255,.2); display:grid; place-items:center; box-shadow: 0 6px 16px rgba(0,0,0,.35); }
    .type-icon svg { width:24px; height:24px; display:block; }
    .type-icon.blog { background: rgba(10, 42, 66, .75); }
    .type-icon.gallery { background: rgba(32, 58, 26, .75); }
    .type-icon.video { background: rgba(84, 20, 20, .75); }
